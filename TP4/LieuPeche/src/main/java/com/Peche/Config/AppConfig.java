...
// Spring
@ComponentScan(basePackages = { "com" }) // Packages à scanner pour chercher les beans spring de type component
...
public class AppConfig implements WebMvcConfigurer {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		dataSource.setUrl("jdbc:mariadb://localhost:3306/peche_location"); // L'url d'accès à la base de données
